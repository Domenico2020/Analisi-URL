...
list_of_error = extractor.list_of_error
...
for errore in list_of_cycles:
     if errore.startswith('http'):
         r= requests.get(errore)
     else:
         r= requests.get('https://www.'+errore)
     if not r == 200:
         list_of_error = list_of_error.append(errore)
