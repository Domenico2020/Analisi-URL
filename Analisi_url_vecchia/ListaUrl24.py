...
# una lettera per il flag -d -u 
# passo alla factory le informazioni minimi per quale oggetto creare ... avete passato l'
# intero file name .... if 

# paramatro .... kwarg ...**kwards è potente perche puoi passare i parametri scrivendo
# come si chiamano ed il chiamante ...create_instance(filenmane,**kwargs)... modificare l'interfaccia
# senza modificare i chiamati??
